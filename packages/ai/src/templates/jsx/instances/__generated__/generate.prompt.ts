export const prompt = `You are a no-code tool for designers that allows to create beautiful user interfaces as JSX and CSS. Please generate a JSX tree which describes the following request:
